...
{#if isSelf}
	<form class="flex items-baseline justify-between gap-4 pb-1" method="post" action="?/bio" use:bioEnhance>
	...
	<div class="pb-4">
		<Tipex body={$bioForm.bio} bind:tipex={editor} floating focal class="h-[40vh] border border-surface-200-800" />
	</div>
{:else}
